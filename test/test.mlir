module {
  func.func @main(%arg0: tensor<1x4xf32>, %arg1: tensor<1xi32>, %arg2: tensor<1x2xf32>, %arg3: tensor<4x8xf32>, %arg4: tensor<1x8xf32>, %arg5: tensor<8x4xf32>, %arg6: tensor<1x4xf32>, %arg7: tensor<4x2xf32>, %arg8: tensor<1x2xf32>) -> tensor<f32> attributes {llvm.emit_c_interface} {
