module {
  func.func @main(%arg0: memref<8x1024xi16, 1>, %arg1: memref<8x1024xi16, 1>, %arg2: memref<1x1024xi64, 1>, %arg3: memref<50304x384xf32, 1>, %arg4: memref<1024x384xf32, 1>, %arg5: memref<384xf32, 1>, %arg6: memref<384xf32, 1>, %arg7: memref<384x1536xf32, 1>, %arg8: memref<1536xf32, 1>, %arg9: memref<1536x384xf32, 1>, %arg10: memref<384xf32, 1>, %arg11: memref<384xf32, 1>, %arg12: memref<384xf32, 1>, %arg13: memref<384x1536xf32, 1>, %arg14: memref<1536xf32, 1>, %arg15: memref<1536x384xf32, 1>, %arg16: memref<384xf32, 1>, %arg17: memref<384xf32, 1>, %arg18: memref<384xf32, 1>, %arg19: memref<384x1536xf32, 1>, %arg20: memref<1536xf32, 1>, %arg21: memref<1536x384xf32, 1>, %arg22: memref<384xf32, 1>, %arg23: memref<384xf32, 1>, %arg24: memref<384xf32, 1>, %arg25: memref<384x50304xf32, 1>, %arg26: memref<1xf32, 1> {bufferization.writable = true}, %arg27: memref<1x1024xi64, 1> {bufferization.writable = true}, %arg28: memref<50304x384xf32, 1> {bufferization.writable = true}, %arg29: memref<1024x384xf32, 1> {bufferization.writable = true}, %arg30: memref<384xf32, 1> {bufferization.writable = true}, %arg31: memref<384xf32, 1> {bufferization.writable = true}, %arg32: memref<384x1536xf32, 1> {bufferization.writable = true}, %arg33: memref<1536xf32, 1> {bufferization.writable = true}, %arg34: memref<1536x384xf32, 1> {bufferization.writable = true}, %arg35: memref<384xf32, 1> {bufferization.writable = true}, %arg36: memref<384xf32, 1> {bufferization.writable = true}, %arg37: memref<384xf32, 1> {bufferization.writable = true}, %arg38: memref<384x1536xf32, 1> {bufferization.writable = true}, %arg39: memref<1536xf32, 1> {bufferization.writable = true}, %arg40: memref<1536x384xf32, 1> {bufferization.writable = true}, %arg41: memref<384xf32, 1> {bufferization.writable = true}, %arg42: memref<384xf32, 1> {bufferization.writable = true}, %arg43: memref<384xf32, 1> {bufferization.writable = true}, %arg44: memref<384x1536xf32, 1> {bufferization.writable = true}, %arg45: memref<1536xf32, 1> {bufferization.writable = true}, %arg46: memref<1536x384xf32, 1> {bufferization.writable = true}, %arg47: memref<384xf32, 1> {bufferization.writable = true}, %arg48: memref<384xf32, 1> {bufferization.writable = true}, %arg49: memref<384xf32, 1> {bufferization.writable = true}, %arg50: memref<384x50304xf32, 1> {bufferization.writable = true}) attributes {llvm.emit_c_interface} {
    %0 = bufferization.to_tensor %arg0 restrict : memref<8x1024xi16, 1> to tensor<8x1024xi16, #nova.device<"1">>
    %1 = bufferization.to_tensor %arg1 restrict : memref<8x1024xi16, 1> to tensor<8x1024xi16, #nova.device<"1">>
    %2 = bufferization.to_tensor %arg2 restrict : memref<1x1024xi64, 1> to tensor<1x1024xi64, #nova.device<"1">>
    %3 = bufferization.to_tensor %arg3 restrict : memref<50304x384xf32, 1> to tensor<50304x384xf32, #nova.device<"1">>
    %4 = bufferization.to_tensor %arg4 restrict : memref<1024x384xf32, 1> to tensor<1024x384xf32, #nova.device<"1">>
    ...
    %7 = bufferization.to_tensor %arg7 restrict : memref<384x1536xf32, 1> to tensor<384x1536xf32, #nova.device<"1">>
    %8 = bufferization.to_tensor %arg8 restrict : memref<1536xf32, 1> to tensor<1536xf32, #nova.device<"1">>
    %9 = bufferization.to_tensor %arg9 restrict : memref<1536x384xf32, 1> to tensor<1536x384xf32, #nova.device<"1">>
    %10 = bufferization.to_tensor %arg10 restrict : memref<384xf32, 1> to tensor<384xf32, #nova.device<"1">>
    %11 = bufferization.to_tensor %arg11 restrict : memref<384xf32, 1> to tensor<384xf32, #nova.device<"1">>
    %12 = bufferization.to_tensor %arg12 restrict : memref<384xf32, 1> to tensor<384xf32, #nova.device<"1">>
    %13 = bufferization.to_tensor %arg13 restrict : memref<384x1536xf32, 1> to tensor<384x1536xf32, #nova.device<"1">>
    %14 = bufferization.to_tensor %arg14 restrict : memref<1536xf32, 1> to tensor<1536xf32, #nova.device<"1">>
    %15 = bufferization.to_tensor %arg15 restrict : memref<1536x384xf32, 1> to tensor<1536x384xf32, #nova.device<"1">>
    %16 = bufferization.to_tensor %arg16 restrict : memref<384xf32, 1> to tensor<384xf32, #nova.device<"1">>
    %17 = bufferization.to_tensor %arg17 restrict : memref<384xf32, 1> to tensor<384xf32, #nova.device<"1">>
    %18 = bufferization.to_tensor %arg18 restrict : memref<384xf32, 1> to tensor<384xf32, #nova.device<"1">>
    %19 = bufferization.to_tensor %arg19 restrict : memref<384x1536xf32, 1> to tensor<384x1536xf32, #nova.device<"1">>
    %20 = bufferization.to_tensor %arg20 restrict : memref<1536xf32, 1> to tensor<1536xf32, #nova.device<"1">>
    %21 = bufferization.to_tensor %arg21 restrict : memref<1536x384xf32, 1> to tensor<1536x384xf32, #nova.device<"1">>
    %22 = bufferization.to_tensor %arg22 restrict : memref<384xf32, 1> to tensor<384xf32, #nova.device<"1">>
    %23 = bufferization.to_tensor %arg23 restrict : memref<384xf32, 1> to tensor<384xf32, #nova.device<"1">>
    %24 = bufferization.to_tensor %arg24 restrict : memref<384xf32, 1> to tensor<384xf32, #nova.device<"1">>
    %25 = bufferization.to_tensor %arg25 restrict : memref<384x50304xf32, 1> to tensor<384x50304xf32, #nova.device<"1">>
    %26 = nova.gather %3 [%0] : tensor<50304x384xf32, #nova.device<"1">>, tensor<8x1024xi16, #nova.device<"1">> -> tensor<8x1024x384xf32>
    %27 = nova.gather %4 [%2] : tensor<1024x384xf32, #nova.device<"1">>, tensor<1x1024xi64, #nova.device<"1">> -> tensor<1x1024x384xf32>
    %28 = nova.add %26, %27 : tensor<8x1024x384xf32>, tensor<1x1024x384xf32>
    %29 = nova.layer_norm %28, %5, %6 : tensor<8x1024x384xf32>, tensor<384xf32, #nova.device<"1">>, tensor<384xf32, #nova.device<"1">>
    %30 = nova.linear %29, %7, %8 : tensor<8x1024x384xf32>, tensor<384x1536xf32, #nova.device<"1">>, tensor<1536xf32, #nova.device<"1">>
    %31 = nova.gelu %30 : tensor<8x1024x1536xf32>
    %32 = nova.linear %31, %9, %10 : tensor<8x1024x1536xf32>, tensor<1536x384xf32, #nova.device<"1">>, tensor<384xf32, #nova.device<"1">>
    %33 = nova.add %28, %32 : tensor<8x1024x384xf32>, tensor<8x1024x384xf32>
    %34 = nova.layer_norm %33, %11, %12 : tensor<8x1024x384xf32>, tensor<384xf32, #nova.device<"1">>, tensor<384xf32, #nova.device<"1">>
    %35 = nova.linear %34, %13, %14 : tensor<8x1024x384xf32>, tensor<384x1536xf32, #nova.device<"1">>, tensor<1536xf32, #nova.device<"1">>
    %36 = nova.gelu %35 : tensor<8x1024x1536xf32>
    %37 = nova.linear %36, %15, %16 : tensor<8x1024x1536xf32>, tensor<1536x384xf32, #nova.device<"1">>, tensor<384xf32, #nova.device<"1">>
    %38 = nova.add %33, %37 : tensor<8x1024x384xf32>, tensor<8x1024x384xf32>
    %39 = nova.layer_norm %38, %17, %18 : tensor<8x1024x384xf32>, tensor<384xf32, #nova.device<"1">>, tensor<384xf32, #nova.device<"1">>
    %40 = nova.linear %39, %19, %20 : tensor<8x1024x384xf32>, tensor<384x1536xf32, #nova.device<"1">>, tensor<1536xf32, #nova.device<"1">>
    %41 = nova.gelu %40 : tensor<8x1024x1536xf32>
    %42 = nova.linear %41, %21, %22 : tensor<8x1024x1536xf32>, tensor<1536x384xf32, #nova.device<"1">>, tensor<384xf32, #nova.device<"1">>
    %43 = nova.add %38, %42 : tensor<8x1024x384xf32>, tensor<8x1024x384xf32>
    %44 = nova.layer_norm %43, %23, %24 : tensor<8x1024x384xf32>, tensor<384xf32, #nova.device<"1">>, tensor<384xf32, #nova.device<"1">>
    %45 = nova.reshape %44 : tensor<8x1024x384xf32> -> tensor<8192x384xf32>
    %46 = nova.matmul %45, %25 : tensor<8192x384xf32>, tensor<384x50304xf32, #nova.device<"1">>
    %47 = nova.reshape %46 : tensor<8192x50304xf32> -> tensor<8x1024x50304xf32>
    %48 = nova.sce %47, %1 : tensor<8x1024x50304xf32>, tensor<8x1024xi16, #nova.device<"1">>
    %49 = nova.constant {value = dense<1.000000e+00> : tensor<1xf32>} : tensor<1xf32>
    %50 = nova.sce_backward %47, %1 : tensor<8x1024x50304xf32>, tensor<8x1024xi16, #nova.device<"1">>
