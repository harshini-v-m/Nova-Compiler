...
// RUN:   -canonicalize -cse \
// RUN:   -nova-gpu-apply-tiling-level-thread \
// RUN:   -canonicalize -cse \
// RUN: | FileCheck %s

// CHECK-LABEL: func.func @thread_tiling_test
// CHECK:       scf.forall
// K-tiling loop
