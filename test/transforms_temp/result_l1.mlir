          ...
          %7 = scf.for %arg9 = %c0 to %c256 step %c128 iter_args(%arg10 = %arg8) -> (tensor<256x256xf32>) {
            ...
            %8 = scf.for %arg11 = %c0 to %c128 step %c32 iter_args(%arg12 = %extracted_slice_13) -> (tensor<128x128xf32>) {
              %9 = scf.for %arg13 = %c0 to %c128 step %c32 iter_args(%arg14 = %arg12) -> (tensor<128x128xf32>) {
                ...
                %10 = linalg.fill ins(%cst_0 : f32) outs(%extracted_slice_17 : tensor<32x32xf32>) -> tensor<32x32xf32>
                %11 = linalg.matmul ins(%extracted_slice_15, %extracted_slice_16 : tensor<32x1024xf32>, tensor<1024x32xf32>) outs(%10 : tensor<32x32xf32>) -> tensor<32x32xf32>
                ...
                %12 = linalg.generic {indexing_maps = [#map, #map1], iterator_types = ["parallel", "parallel"]} ins(%extracted_slice_18 : tensor<1x32xf32>) outs(%extracted_slice_19 : tensor<32x32xf32>) {
                ^bb0(%in: f32, %out: f32):
                  linalg.yield %in : f32
                } -> tensor<32x32xf32>
                %extracted_slice_20 = tensor.extract_slice %extracted_slice_12[%arg11, %arg13] [32, 32] [1, 1] : tensor<128x128xf32> to tensor<32x32xf32>
                %13 = linalg.generic {indexing_maps = [#map1, #map1, #map1], iterator_types = ["parallel", "parallel"]} ins(%11, %12 : tensor<32x32xf32>, tensor<32x32xf32>) outs(%extracted_slice_20 : tensor<32x32xf32>) {
                ^bb0(%in: f32, %in_23: f32, %out: f32):
                  %15 = arith.addf %in, %in_23 : f32
                  linalg.yield %15 : f32
                } -> tensor<32x32xf32>
                %extracted_slice_21 = tensor.extract_slice %arg14[%arg11, %arg13] [32, 32] [1, 1] : tensor<128x128xf32> to tensor<32x32xf32>
                %14 = linalg.generic {indexing_maps = [#map1, #map1, #map1], iterator_types = ["parallel", "parallel"]} ins(%13, %cst : tensor<32x32xf32>, tensor<32x32xf32>) outs(%extracted_slice_21 : tensor<32x32xf32>) {
                ^bb0(%in: f32, %in_23: f32, %out: f32):
                  %15 = arith.maximumf %in, %in_23 : f32
                  linalg.yield %15 : f32
                } -> tensor<32x32xf32>
                %inserted_slice_22 = tensor.insert_slice %14 into %arg14[%arg11, %arg13] [32, 32] [1, 1] : tensor<32x32xf32> into tensor<128x128xf32>
