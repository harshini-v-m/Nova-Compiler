module {
  ...
  func.func @test_gpu_only(%arg0: tensor<16x16xf32, #nova.device<"1">>, %arg1: tensor<16x16xf32, #nova.device<"1">>) -> tensor<16x16xf32, #nova.device<"1">> attributes { llvm.emit_c_interface } {
    %sum = nova.add %arg0, %arg1 : tensor<16x16xf32>, tensor<16x16xf32>
    %prod = nova.matmul %sum, %arg0 : tensor<16x16xf32>, tensor<16x16xf32>
  ...
  func.func @test_mixed_h2d(%arg0: tensor<32x32xf32, #nova.device<"0">>) -> tensor<32x32xf32, #nova.device<"1">> attributes { llvm.emit_c_interface } {
    %gpu_in = nova.to_device %arg0 : tensor<32x32xf32, #nova.device<"0">> -> tensor<32x32xf32>
    %res = nova.add %gpu_in, %gpu_in : tensor<32x32xf32>, tensor<32x32xf32>
  ...
  func.func @test_mixed_d2h(%arg0: tensor<32x32xf32, #nova.device<"1">>) -> tensor<32x32xf32, #nova.device<"0">> attributes { llvm.emit_c_interface } {
    %gpu_sum = nova.add %arg0, %arg0 : tensor<32x32xf32>, tensor<32x32xf32>
    %cpu_in = nova.to_device %gpu_sum : tensor<32x32xf32> -> tensor<32x32xf32, #nova.device<"0">>
  ...
  func.func @test_stress_chain(%arg0: tensor<64x64xf32, #nova.device<"1">>) -> tensor<64x64xf32, #nova.device<"1">> attributes { llvm.emit_c_interface } {
    %sum = nova.add %arg0, %arg0 : tensor<64x64xf32>, tensor<64x64xf32>
    %prod = nova.matmul %sum, %arg0 : tensor<64x64xf32>, tensor<64x64xf32>
    %gelu = nova.gelu %prod : tensor<64x64xf32>
    %soft = nova.softmax %gelu {dimension = 1 : i32} : tensor<64x64xf32>
